...
#ALLOWED_HOSTS = ['192.168.0.118'] # Local network IP for development on devices
...
DEFAULT_FROM_EMAIL = 'Finko <noreply@finkoapp.com>'  # not used here
